...
export default function App() {
  ...
  function alerta() {
    alert('É GOOOOOOL JUNINHOOOOOOOOOOO!!!!!!!')
  }
  ...
  return (
    <ScrollView>
      ...
      <View style={styles.container}>
        ...
        <Text style={styles.textoGrande} >Juninho</Text>
        <Text style={styles.texto} >Antônio Augusto Ribeiro Reis Júnior, mais conhecido como Juninho Pernambucano, é um ex-futebolista brasileiro que atuava como meio-campista. Um dos maiores ídolos da história do Vasco da Gama e maior ídolo da história do Lyon, fez parte de gerações vitoriosas de ambos os clubes.</Text>
